  ...
  return (
    <section className="py-24 px-6 bg-rule/10">
      <div className="max-w-6xl mx-auto">
        <SectionTitle en="LOCATION & CONTACT" ko="오시는 길" enColor="text-night" />
        ...
        <div className="mt-14 grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            {/* 병원 정보 */}
            <div>
              <p className="font-serif text-night text-xs tracking-[0.3em] mb-3">HOSPITAL INFO</p>
              <h3 className="font-serif-ko text-ink text-2xl font-light mb-4">리브한의원</h3>
              <address className="not-italic flex flex-col gap-2 text-sm text-ink leading-relaxed">
                <div className="flex items-start gap-3">
                  ...
                  <span>서울특별시 강남구 언주로98길 31-6</span>
                </div>
            ...
            {/* 진료시간 테이블 */}
            <div>
              <p className="font-serif text-night text-xs tracking-[0.3em] mb-4">HOURS</p>
